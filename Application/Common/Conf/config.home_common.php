...
defined('DOMAIN') or define('DOMAIN', "http://hdev.duinin.com/index.php");
...
//    'DB_MASTER_NUM' => 1, // 读写分离后 主服务器数量
    ...
    'send_wx_msg' => 'http://hm.duinin.com/index.php?m=Service&c=SendMessage&a=sendWxMsg', // 发送微信客服消息接口地址
