...
defined('XXAPI') or define('XXAPI', "http://dev-mapi.duinin.com");
defined('XXID') or define('XXID', "http://dev-mapi.duinin.com");
defined('TXIM_APPID') or define('TXIM_APPID', "1400095631");
defined('TXIM_AccountTYPE') or define('TXIM_AccountTYPE', "27520");
...
return array(
    /* 数据库设置 */
    'DB_TYPE' => 'mysql',// 数据库类型
    'DB_HOST' => '127.0.0.1', //'127.0.0.1',//测试 服务器地址
...
//    'DB_MASTER_NUM' => 1, // 读写分离后 主服务器数量
    ...
    /*API地址*/
    'api_url' => "http://dev-mapi.duinin.com/index.php", // 迅信接口
    ...
    'send_wx_msg' => 'http://dev.duinin.com/index.php?m=Service&c=SendMessage&a=sendWxMsg', // 发送微信客服消息接口地址
    'new_api_url' => 'http://dev-mapi.duinin.com/index.php',
    ...
    /*杂项*/
    'MALL_DOMAIN' => 'dev.duinin.com',  // 商城访问域名
